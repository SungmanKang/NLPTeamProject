            ...
            try:
                ...
                if len(batches) > 1:
                    ...
                    for batch in batches:
                        ...
                        #Modify by SM ( 20221121 )
                        padding = torch.zeros((nr_of_words, max_nr_of_ngrams - batch_nr_of_ngrams), dtype=torch.long, requires_grad = True)
